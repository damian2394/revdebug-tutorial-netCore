...
{
    public class InvoicesInitializer
    {
        public void Seed(InvoicesContext context)
        {
            ...
            {
                new Invoice {Number = 1, InvoiceId = "222/ST/" + DateTime.Now.Year, AccountId = 1, IssueDate = DateTime.Now.AddDays(-25).AddHours(-4).AddMinutes(20), DueDate = DateTime.Now.AddDays(24).AddHours(-4).AddMinutes(20)},
                new Invoice {Number = 2, InvoiceId = "88/SU/05/" + DateTime.Now.Year, AccountId = 3, IssueDate = DateTime.Now.AddDays(-12).AddHours(-2).AddMinutes(45), DueDate = DateTime.Now.AddDays(15).AddHours(-4).AddMinutes(20)},
                new Invoice {Number = 3, InvoiceId = "135/ST/GD/05/" + DateTime.Now.Year, AccountId = 2, IssueDate = DateTime.Now.AddDays(-16).AddHours(-9).AddMinutes(24), DueDate = DateTime.Now.AddDays(8).AddHours(-4).AddMinutes(20)}
            };
